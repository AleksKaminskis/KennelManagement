...
namespace Server.Migrations
{
    ...
    [Migration("20260121004952_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Models.Dog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Server.Models.Kennel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Server.Models.Booking", b =>
                {
                    b.HasOne("Server.Models.Dog", "Dog")
                        .WithMany("Bookings")
                        .HasForeignKey("DogId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Server.Models.Kennel", "Kennel")
                        .WithMany("Bookings")
